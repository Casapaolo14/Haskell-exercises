...
happyExpList = Happy_Data_Array.listArray (0,17) ([256,4100,0,1985,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_rpnScanner","Exp","'+'","'-'","'*'","'/'","int","%eof"]
...
happyReduction_1 (HappyTerminal happy_var_3)
	_
	(HappyAbsSyn4  happy_var_1)
	 =  HappyAbsSyn4
		 (happy_var_1 happy_var_3 Plus
	)
...
rpnScanner tks = happyRunIdentity happySomeParser where
