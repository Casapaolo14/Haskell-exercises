...
happyExpList = Happy_Data_Array.listArray (0,26) ([4320,32,2,0,0,0,128,2048,512,270,8200,16384,3584,4097,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_hsScanner","Exp","Factor","var","int","'let'","'in'","'case'","'of'","'='","fun","%eof"]
...
happyNewToken action sts stk (tk:tks) =
	...
	TokenOf -> cont 11;
	TokenEq -> cont 12;
	TokenFun happy_dollar_dollar -> cont 13;
	_ -> happyError' ((tk:tks), [])
	}
...
hsScanner tks = happyRunIdentity happySomeParser where
